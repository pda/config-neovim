...
-- a visual marker after column 100
...
vim.keymap.set('n', '<Up>', '<C-W><Up>', { desc = 'Move focus to the left window' })
vim.keymap.set('n', '<Down>', '<C-W><Down>', { desc = 'Move focus to the right window' })
vim.keymap.set('n', '<Left>', '<C-W><Left>', { desc = 'Move focus to the lower window' })
vim.keymap.set('n', '<Right>', '<C-W><Right>', { desc = 'Move focus to the upper window' })
